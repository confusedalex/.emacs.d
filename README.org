...
#+author: confusedalex
#+property: header-args  :noweb yes :tangle init.el
#+startup: fold
...
#+end_src
* System tweaks
Because I run emacs on linux and macos machines, I want to make some system specific tweaks.
#+begin_src emacs-lisp
...
#+end_src
** git
For merging conflicts emacs already bundles smerge-mode. But the
default keybind is very cumbersome
#+begin_src emacs-lisp
